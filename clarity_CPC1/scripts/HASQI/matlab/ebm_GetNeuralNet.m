...
NNparam=zeros(6,1);
NNparam(1)=10; %Number of neurons in the input layer
NNparam(2)= 4; %Number of neurons in the hidden layer
NNparam(3)= 1; %Number of neurons in the output layer
NNparam(4)= 1; %Activation function is logsig
NNparam(5)= 0; %No offset for the activation function
NNparam(6)= 1; %Maximum activation function value

% Input to hidden layer weights
Whid=cell(10,1);
Whid{1}=[  4.9980  -13.0590    9.5478  -11.6760;
...
Whid{2}=[-11.8283  -12.3466    8.8198    5.6027;
...
Whid{3}=[ 9.5379    4.4994  -13.1308    0.9024;
...
Whid{4}=[  9.3527  -13.3654   -2.1263    5.1205;
...
Whid{5}=[-12.0509    8.7151   12.9841  -12.7563;
...
Whid{6}=[  8.9905  -16.4000   13.3395    8.9068;
...
Whid{7}=[-13.2736    9.9119    3.4659    2.8783;
...
Whid{8}=[-11.6727  -15.7084    9.9095   -7.3946;
...
Whid{9}=[-13.9106    3.1943    8.7525    7.8378;
...
Whid{10}=[ 13.5754  -13.4585    2.5816    7.5809;
...
Wout=cell(10,1);
Wout{1}=[-0.1316; -2.5182;  1.6401; -3.2093;  1.7924];
Wout{2}=[-0.1653;  1.7375;  1.5526; -3.2349; -2.2877];
Wout{3}=[ 0.1847; -3.1987; -2.4941;  2.7106; -1.8048];
Wout{4}=[ 0.3962; -3.2952;  3.0003; -2.2602; -2.3269];
Wout{5}=[-0.0646;  1.3288; -3.4087; -2.0046;  1.8565];
Wout{6}=[ 1.3676; -3.4129;  1.6895; -1.8913; -1.5595];
Wout{7}=[ 0.8124;  2.7171; -3.0867; -2.3310; -2.3657];
Wout{8}=[-0.2743;  1.4949;  0.7896; -4.0589;  1.1257];
Wout{9}=[ 0.1307;  2.2788; -2.3633; -1.5073; -2.9985];
Wout{10}=[0.1024; -0.9517;  2.2123; -2.4008; -3.1655];
